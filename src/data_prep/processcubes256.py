...
"""
Extracts 256x256x256 seismic patches for multi-scale salt detection training.

Parallel usage (split by inline range across machines):
    py src/data_prep/processcubes256.py 0 1954
    python src/data_prep/processcubes256.py 1954 3908
    py src/data_prep/processcubes256.py 3908 5862

Single machine:
    python processcubes256.py
"""
...
# Cube size — all dimensions 256
CUBE_SIZE = 256         # inline, crossline, and time all 256

# Strides — denser in Z since it is the shallowest dimension (only 1081 samples)
STRIDE_INLINE     = 128
STRIDE_CROSSLINE  = 128
STRIDE_Z          = 64
